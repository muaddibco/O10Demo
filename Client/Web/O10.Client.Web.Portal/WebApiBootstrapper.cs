...
namespace O10.Client.Web.Portal
{
    ...
    {
        private readonly string[] _catalogItems = new string[] { "O10.Client.Web.Common.dll", "O10.Client.Web.Portal.dll", "O10.Server.Saml.Common.dll", "O10.Server.IdentityProvider.Common.dll" };
